            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="grid grid-cols-12">
                    @foreach ($brands as $brand)
                        ...
                        <x-jet-label class="lg:col-span-3 md:col-span-4 col-span-6">
                            <x-jet-checkbox
                            wire:model.defer="createForm.brands"
                            name="brands[]"
                            value="{{$brand->id}}" />
                            {{ Str::limit($brand->name, 10, '...') }}
                        </x-jet-label>
                    ...
                    <div class="grid grid-cols-4">
                        @foreach ($brands as $brand)
                            ...
                            <div class="md:col-span-1 col-span-4">
                                <x-jet-label>
                                    <input type="checkbox" name="brands[]" wire:model.defer="editForm.brands" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" @if($category->brands->contains($brand)) checked @endif value="{{$brand->id}}">
                                    {{$brand->name}}
                                </x-jet-label>
                            </div>
