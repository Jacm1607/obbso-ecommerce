...
<body class="font-sans antialiased">
    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        <aside class="z-20 hidden w-64 overflow-y-auto bg-purple-800 bg-opacity-5 dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    @can('brand.index')
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ route('admin.brands.index') }}">
                            ➡
                    ...
                    <li class="relative px-6 py-3">
                        <a href="{{ route('admin.departaments.index') }}" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            ➡
                                ...
                                aria-label="submenu">
                                    @can('product.index')
                                        <li
                                            ...
                                            <a href="{{ route('admin.users.index') }}" class="w-full" href="">Usuarios</a>
                                        </li>
                                    @endcan
                                    @can('rol.index')
                                        <li
                                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                            <a href="{{ route('admin.roles.index') }}" class="w-full" href="">Rol</a>
                                        </li>
                                    @endcan
                                    @can('privilege.index')
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a href="{{ route('admin.privileges.index') }}" class="w-full" href="">Privilegio</a>
                                    </li>
                                @endcan
                            </ul>
                        </template>
